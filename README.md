...
6. Evaluate scalability if the system increases from 5 to 10,000 employees. Which
approach scales better and why?

8. Provide a real-world payroll system example. Indicate where Task Parallelism and
